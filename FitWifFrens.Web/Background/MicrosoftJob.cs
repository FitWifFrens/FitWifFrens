...
{
    public class MicrosoftJob : IJob
    {
        public static readonly JobKey Key = JobKey.Create(nameof(MicrosoftJob));
        ...
        private readonly ILogger<MicrosoftJob> _logger;

        private readonly ResiliencePipeline<HttpResponseMessage> _resiliencePipeline;

        public MicrosoftJob(DataContext dataContext, TimeProvider timeProvider, IHttpClientFactory httpClientFactory,
            RefreshTokenService refreshTokenService, TelemetryClient telemetryClient, ILogger<MicrosoftJob> logger)
        {
        ...
        {
            return UpdateProviderMetricValues(context.CancellationToken);
        }

        private async Task UpdateProviderMetricValues(CancellationToken cancellationToken)
        {
            try
            {
